const First = () => {
    return (
        <div className="first max-w-3xl w-full mx-auto flex flex-col items-start gap-4 lg:pr-25">
            ...
            <div className="buttons mt-2 flex flex-col sm:flex-row items-start sm:items-center gap-3 w-full">
                {/* Primary button */}
                <div className="first-button inline-flex items-center justify-center gap-2 px-5 py-3 sm:px-7 sm:py-3.5 rounded-lg bg-white text-black font-medium shadow hover:bg-white/90 transition w-full sm:w-auto">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                        height="16"
                    ...
                    <a href="../../assets/hero/Resume.pdf" className="text-base sm:text-lg" download="Henil_Patel_Resume.pdf">Resume</a>
                </div>

                {/* Icon buttons */}
                <div className="second-button flex items-center gap-3 sm:gap-4 flex-wrap justify-center sm:justify-start w-full">
                    <a
                        className="w-12 h-12 sm:w-14 sm:h-14 rounded-lg border border-white/10 hover:bg-white/10 transition flex items-center justify-center"
